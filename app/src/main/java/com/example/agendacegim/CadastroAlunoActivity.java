...
public class CadastroAlunoActivity extends AppCompatActivity {
        ...
        mbtn_Cadastrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!maternalRb.isChecked() && !primeiroPeriodoRb.isChecked() && !segundoPeriodoRb.isChecked() && !primerioAnoRb.isChecked() && !segundoAnoRb.isChecked() && !terceiroAnoArb.isChecked()  && !quartoAnoRb.isChecked() && !quintoAnoRb.isChecked()){
                    Toast.makeText(CadastroAlunoActivity.this, "Inserir tipo turma do Aluno...", Toast.LENGTH_SHORT).show();
                ...
                else if (password.length()<8)
                {
                    ...
                    mtxt_senhac.setFocusable(true);
                        ...
                        registerAluno(nomeAluno,nomeResponsavel,email,password,turma,phone,endereco);
                }
            }
    ...
    private void registerAluno(final String nomeAluno, final String nomeResponsavel, String email, String password, final String turma, final String phone, final String endereco) {
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    reference.child(uid).setValue(hashMap);
                        ...
                        Toast.makeText(CadastroAlunoActivity.this,"Registrando...\n"+user.getEmail(),Toast.LENGTH_SHORT);
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(CadastroAlunoActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(CadastroAlunoActivity.this,""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
